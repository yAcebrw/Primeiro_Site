...
include("../acoes/register_produto.php");
                ...
                <form action="" method="POST">
                  ...
                  <select class="form-select form-control form-control-lg mb-4" aria-label="Default select example" name="categoria">
                    ...
                    <div class="mb-4 mt-4 ms-2">
                      ...
                      <input type="text" class="currency-input" placeholder="0,00" aria-label="Preço em Reais" oninput="formatPrice(this)" name="preco" />
                  </div>
                  ...
                  <div class="d-flex justify-content-center">
                    <button  type="submit" data-mdb-button-init
                      data-mdb-ripple-init class="btn btn-primary btn-block btn-lg gradient-custom-4 text-body">Cadastrar</button>
                  </div>
